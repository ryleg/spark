...
import org.apache.spark.serializer.{JavaSerializer, SerializationConstruction, Serializer, SerializerManager}
...
class SparkEnv (
    ...
    val serializerDefault: Serializer,
    val closureSerializerDefault: Serializer,
